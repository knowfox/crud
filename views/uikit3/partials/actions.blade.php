<div style="display:inline-block;text-align:left;">
    <a class="uk-button uk-button-default uk-button-small" uk-icon="pencil" title="@lang('Edit #:id', ['id' => $entity->id])" href="{{ route($route_prefix . $entity_name . '.edit', $entity) }}"></a>
    @if ($downloads)
    ...
    @endif
    @if ($deletes)
        <a class="uk-button uk-button-default uk-button-small" uk-icon="trash" title="@lang('Delete #:id', ['id' => $entity->id])" href="#"
